  ...
  return (
    <>
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-16 bg-neutral-900 text-white text-sm px-3 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
      ...
      {showBackToTop && (
        ...
        >
          ...
          {/* Tooltip */}
          <span className="absolute left-16 bg-neutral-900 text-white text-sm px-3 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
            Retour en haut
          </span>
        </button>
      )}
